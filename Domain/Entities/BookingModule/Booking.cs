...
{
    public class BookingObjectModule : BookingDetails
    {
        public IList<BookingDetails> OldBookingList { get; set; }
        public IList<BookingDetails> NewBookingList { get; set; }
        public BookingDetails ClickSlotItem { get; set; }
        public BookingObjectModule()
        {
            OldBookingList = new List<BookingDetails>();
            NewBookingList = new List<BookingDetails>();
            ClickSlotItem = new BookingDetails();
        }
    }
