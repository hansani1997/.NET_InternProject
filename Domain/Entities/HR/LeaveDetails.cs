...
namespace BlueLotus360.CleanArchitecture.Domain.Entities.HR
{
    public class LeaveDetails
    {
        ...
        public int LevReasonKy { get; set; } = 1;
        public string? RejectReason { get; set; }
        public int StatusKy { get; set; } = 1;
        public string? Status { get; set; }
        public string? NextStatus { get; set; }
        public string? StatusCode { get; set; }
        public string? LeaveType { get; set; }
        public int LevTrnKy { get; set; } = 1;
        public int LevTrnTypKy { get; set; } = 1;
        public int LeaveTypeKy { get; set; } = 1;
        ...
        public int ReporterKey { get; set; } = 1;
        ...
        public LeaveDetails()
        {
            NextApprovedStatus = new CodeBaseResponse();
        }
    }
    ...
    public class Leaverequest
    {
        ...
        public CodeBaseResponse LevReason { get; set; } = new CodeBaseResponse();
        public string? OtherReason { get; set; }
        ...
        public int ReporterKy { get; set; } = 1;
