...
namespace bluelotus360.com.razorComponents.Pages.Utilities.Approval
{
    public partial class TransactionApprovalStatusUpdateSimple
    {
        ...
        private BLTable<BLTransaction> _mudGrid;
        ...
        {
            BLTransaction find = new BLTransaction();
            find = (args.sender as BLCodeBaseCombo).ComboDataObject as BLTransaction;
            args.DataObject.AddtionalData.Add("ApproveStatusKey", find.ApproveState.CodeKey);
            args.DataObject.AddtionalData.Add("TransactionKey", find.TransactionKey);
