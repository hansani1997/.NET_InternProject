...
{
    public partial class SalesOrderDistributor
    {
        ...
        private BLTable<OrderItem> _mudGrid;
        ...
        private async void InitilizeNewOrder()
        {
            ...
            editUIElement = new();
            _mudGrid = new();
            this.ToggleEditability("HeaderSection1_Location", true);
        ...
        private void HookInteractions()
        {
            ...
            appStateService._AppBarName = "Sales Order Distributor";
        ...
        {
            order.SelectedOrderItem.TransactionUnit=args.DataObject;
            UIStateChanged();
        }
        ...
        private async void OnAddItemButtonClick(UIInterectionArgs<object> args)
        {
            ...
            if (validator!=null  && validator.CanAddItemToGrid())
            {
                ...
                if (order.OrderItems.Count() > 0)
                {
                    this.ToggleEditability("HeaderSection1_Location", false);
                }
            }
