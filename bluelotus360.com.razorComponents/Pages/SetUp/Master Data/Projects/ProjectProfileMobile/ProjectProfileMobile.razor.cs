...
namespace bluelotus360.com.razorComponents.Pages.SetUp.Master_Data.Projects.ProjectProfileMobile
{
    public partial class ProjectProfileMobile
    {
        ...
        private BLTable<ProjectProfileList> _mudgrid;
        ...
        private async void EditProfile(UIInterectionArgs<object> args)
        {
            ...
            updatedDetails.CopyFrom(currentDetails);
