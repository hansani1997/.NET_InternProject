...
namespace bluelotus360.com.razorComponents.MB.Shared.Components
{
	public partial class BLTimePicker : IBLUIOperationHelper
	{
        ...
        private PropertyConversionResponse<TimeSpan> conversionInfo;
		...
		protected override void OnParametersSet()
		{
            ...
            conversionInfo = DataObject.GetPropObject<TimeSpan>(UIElement.DefaultAccessPath);
            if (conversionInfo.IsConversionSuccess)
            {
                time = conversionInfo.Value;
            }
