...
{
    public partial class BLThemeProvider : ComponentBase, IDisposable
    {
        [Parameter]
        ...
        public BLThemeProvider()
        {
            _dotNetRef = DotNetObjectReference.Create(this);
        }
        private readonly DotNetObjectReference<BLThemeProvider> _dotNetRef;
        ...
        protected  void GenerateTheme(StringBuilder theme)
        {
            if (Theme == null)
                return;
