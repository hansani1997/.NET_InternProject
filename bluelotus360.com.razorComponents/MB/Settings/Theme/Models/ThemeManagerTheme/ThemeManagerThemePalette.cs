...
public class ThemeManagerThemePalette
{
    ...
    //Add some properties for use scss

    public string UIBackgroundColor { get; set; }
    public string AppBarBackgroundColor { get; set; }
    public string ColorPrimaryText { get; set; }
    public string ColorSecondaryText { get; set; }
    public string ColorLightText { get; set; }
    public string AlertBackgroundColor { get; set; }
    public string ColorIconDefault { get; set; }
    public string ColorOrange { get; set; }
    public string ColorCompanyAvatars { get; set; }
    public string PaletteWhite { get; set; }
    public string PaletteOffWhite { get; set; }
    public string PaletteBlack { get; set; }
    public string PaletteGreen { get; set; }
    public string PaletteGray { get; set; }
    public string PaletteDarkGray { get; set; }
    public string PaletteGray2 { get; set; }
    public string PaletteRed { get; set; }
    public string PaletteLightYellow { get; set; }
    public string PaletteBurlyWood { get; set; }
    public string ColorBackgroundColor { get; set; }
    public string ColorTableLines { get; set; }
