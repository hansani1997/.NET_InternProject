...
namespace BlueLotus360.CleanArchitecture.Domain.Entities.Transaction
{
	public class TransactionLineItem : BaseEntity
	{
     ...
     @DlvAdrKy int =1,
		...
		{
			return ItemCategory2.AddtionalData.ContainsKey("IsKiloWash") && Convert.ToBoolean(ItemCategory2.AddtionalData["IsKiloWash"]);
		}
		public bool IsCommonItem()
		{
			return ItemCategory2.AddtionalData.ContainsKey("IsCommon") && Convert.ToBoolean(ItemCategory2.AddtionalData["IsCommon"]);
		}
